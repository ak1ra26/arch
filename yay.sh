...
yay -S google-chrome slack-desktop firefox-beta-bin authy sox windscribe-cli plasma5-applets-eventcalendar discord $yvbox --noconfirm --disable-download-timeout
