...
yay -S google-chrome slack-desktop firefox-beta-bin authy windscribe-cli qt5-imageformats kimageformats plasma5-applets-eventcalendar $yvbox --noconfirm --disable-download-timeout #libpdfium megasync fix!!!!
