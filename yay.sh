...
yay -S google-chrome slack-desktop firefox-beta-bin authy windscribe-cli qt5-imageformats kimageformats plasma5-applets-eventcalendar sni-qt $yvbox spotify --noconfirm --disable-download-timeout
